"""
VERSION 1: Aggressive Curvature - High rad values for left-side edges
"""
...
st.set_page_config(page_title="Version 1 - Aggressive Curves", page_icon="🗺️", layout="wide")
...
def create_network_graph(graph_obj, path=None):
    ...
    # VERSION 1: AGGRESSIVE CURVATURE
    edge_styles = {
        ('A', 'M'): 'arc3,rad=0.4',      # Very curved
        ('A', 'S'): 'arc3,rad=-0.35',    # Very curved opposite
        ('A', 'B'): 'arc3,rad=0.3',
        ('A', 'C'): 'arc3,rad=0.5',      # Maximum curve
        ('B', 'M'): 'arc3,rad=-0.4',     # Very curved
        ('B', 'S'): 'arc3,rad=0.25',
        ('B', 'F'): 'arc3,rad=-0.3',
        ('C', 'M'): 'arc3,rad=-0.5',     # Maximum curve opposite
        ('C', 'R'): 'arc3,rad=0.25',
        ('C', 'T'): 'arc3,rad=0.35',
        ('R', 'M'): 'arc3,rad=0.45',     # Very curved
        ('R', 'F'): 'arc3,rad=0.2',
        ('T', 'F'): 'arc3,rad=-0.3',
        ('T', 'H'): 'arc3,rad=0.25',
        ('F', 'H'): 'arc3,rad=0.2',
    ...
    ax.set_title("VERSION 1: Courbures Agressives", fontsize=18, fontweight='bold', pad=20)
    ax.axis('off')
    ax.margins(0.15)
    plt.tight_layout()
    return fig
...
def main():
    st.markdown('<div class="main-header">🗺️ Version 1: Courbures Agressives</div>', unsafe_allow_html=True)
    st.markdown('<div class="sub-header">Rad élevés pour séparer les liens</div>', unsafe_allow_html=True)
